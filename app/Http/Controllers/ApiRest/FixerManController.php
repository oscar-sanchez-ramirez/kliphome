...
class FixerManController extends ApiController
{
    ...
    public function paymentsFixerman($user_id){
        ...
        $payments = DB::table('selected_orders as so')->join('orders as o','o.id','so.order_id')->leftJoin('quotations as q','o.id','q.order_id')->leftJoin('qualifies as qa','o.id','qa.order_id')->join('payments as p','p.order_id','o.id')
