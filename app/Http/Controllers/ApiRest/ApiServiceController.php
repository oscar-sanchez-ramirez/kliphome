...
class ApiServiceController extends ApiController
{
    ...
    public function categories($ids,$municipio,$user_id)
    {
        ...
        ->select('o.*','a.delegation','a.street as address','a.reference','a.exterior','a.interior','a.postal_code','a.municipio','a.colony','u.name','u.lastName','u.avatar')->orderBy('o.created_at',"DESC")->get();
