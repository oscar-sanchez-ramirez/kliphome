...
class ConversationController extends ApiController
{
  ...
  public function indexRest($id){
    ...
    ->select('c.id','c.contact_id','c.has_blocked','c.listen_notifications','c.last_message','c.last_time','c.order_id','u.name','u.lastName','u.avatar','us.name','us.lastName','us.avatar',DB::raw('IF(c.user_id='.$id.',1,0) as written_by_me'))
