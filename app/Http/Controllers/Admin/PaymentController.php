...
class PaymentController extends Controller
{
    ...
    public function index(){
        ...
        $payments = DB::table('orders as o')->leftJoin('selected_orders as so','o.id','so.order_id')->join('users as u','u.id','so.user_id')->join('fixerman_stats as ft','ft.user_id','u.id')->leftJoin('quotations as q','o.id','q.order_id')->join('payments as p','p.order_id','o.id')
